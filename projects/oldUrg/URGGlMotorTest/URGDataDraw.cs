...
//								Console.WriteLine(p.ToString());
		...
		public void autoscann()
		{
			this.bigfoot.XPos = 45;
			this.bigfoot.YPos = 120;
			save_ok_ = true;
			while (bigfoot.XPos <= 140)
			{
				bigfoot.XPos += 0.04;
				bigfoot.aplyServos();
			}
			save_ok_ = false;
			this.bigfoot.XPos = 115;
			bigfoot.aplyServos();
		}
